...
// These modes all work on IMX477 sensor based cameras.
// xres, yres, buf#, s_role, p_format, color_s, mfps, bright, cont, gain, time, wb_blue, wb_red, rot, ...
// Note: first mode is only used for setting up request buffers that are reused (!) for everything else.

camera_mode camera_modes[] = {
    {4064, 3040, 4, LSR_STILL_CAPTURE, LPF_BGR888, LCS_REC709, 60, 1005, 1010, 1051, 40000, 1250, 1251, 0},
